...
class Parser extends Base {
     ...
     * @return null
     */
    public function __construct($jar, $java_options = array('-mx300m'))
    {
        $this->setJar($jar);
    ...
    public function parseSentences($sentences)
    {
        ...
        $cmd = $this->getJavaPath() . " $options -cp \"" . rtrim(dirname($this->getJar()), DIRECTORY_SEPARATOR) 
            . "/*:\" edu.stanford.nlp.parser.lexparser.LexicalizedParser -encoding UTF-8 -outputFormat \"". $this->getOutputFormat() ."\" " 
            . $parser . " " . $tmpfname;
